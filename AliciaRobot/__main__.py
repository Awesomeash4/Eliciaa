...
PM_START_TEXT = """
ʜᴇʏ ᴛʜᴇʀᴇ🤗, ɪᴍ ᴀʟɪᴄɪᴀ ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ King ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/deekingbot?startgroup=true"),
    ],
    [
...
ALICIA_IMG = "https://telegra.ph/file/5afc6d7c3f48aa6d67000.jpg"
    ...
    if query.data == "alicia_":
        query.message.edit_text(
            text=""" ℹ️ ɪ'ᴍ *ᴀʟɪᴄɪᴀ*, ᴀ ᴘᴏᴡᴇʀꜰᴜʟ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ʙᴜɪʟᴛ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴇᴀꜱɪʟʏ.
                 ...
                 \n\n_ᴀʟɪᴄɪᴀ'ꜱ ʟɪᴄᴇɴꜱᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ ɢɴᴜ ɢᴇɴᴇʀᴀʟ ᴘᴜʙʟɪᴄ ʟɪᴄᴇɴꜱᴇ ᴠ3.0_
                 \nʜᴇʀᴇ ɪꜱ ᴛʜᴇ [💾ʀᴇᴘᴏꜱɪᴛᴏʀʏ](https://github.com/H1M4N5HU0P/AliciaRobotOP).                  
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(alicia_about_callback, pattern=r"alicia_", run_async=True)
